--настройка отвечающая за ui компоненты. Создавалась, чтобы добавить статус в
return {
  ...
  opts = function(_, opts)
    ...
    opts.statusline = { -- statusline
      ...
      status.component.fill(),
      status.component.builder({ provider = function() --строка Codeium
        return vim.fn['codeium#GetStatusString']() end,
        hl = { fg = "grey"},}),
